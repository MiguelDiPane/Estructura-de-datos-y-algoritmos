...
class TestTablaH(unittest.TestCase):
    ...
    def test_buscar_clave_dada_posicion(self):
        ...
        #Verificación
        self.assertEqual(self.__tablaH.buscar_posicion(25),5)
        self.assertEqual(self.__tablaH.buscar_clave(5),25)
    ...
    def test_buscar_clave_dada_clave_inexistente(self):
        ...
        #Verificación
        self.assertEqual(self.__tablaH.buscar_clave(45),None)
