import unittest
from claseGrafoSecuencial import GrafoSecuencial as Grafo
...
class GrafoSecuencialTest(unittest.TestCase):
    ...
    def test_nodos_adyacentes(self):
        ...
        #Verificación
        self.assertEqual(self.__grafo.adyacentes(0),[1,3])
    ...
    def test_camino_grafo_no_ponderado(self):
        ...
        self.assertEqual(self.__grafo.camino(0,5,True),[0,3,1,5])
    ...
    def test_camino_minimo_grafo_no_ponderado(self):
        ...
        self.assertEqual(self.__grafo.camino_minimo(2,3),[2,4,0,3])
    ...
    def test_camino_minimo_grafo_ponderado(self):
        ...
        #Verificación
        self.assertEqual(self.__grafo.camino_minimo(0,6),[0,3,6])
    ...
    def test_obtener_arbol_de_recubrimiento_minimo(self):
        #Condición inicial
        self.__grafo = Grafo(7,True)
        self.__grafo.cargar_nodo(0,20)
        self.__grafo.cargar_nodo(1,34)
        ...
        self.__grafo.relacionar_nodos(5,6,2)
        self.__grafo.obtener_arbol_de_recubrimiento_minimo(0)
